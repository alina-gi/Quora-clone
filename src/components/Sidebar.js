  ...
  return (
    <div className="sidebar">
      <div className="sidebarOptions">
        ...
        <div className="sidebarOption">
          <img
            src="https://qph.fs.quoracdn.net/main-thumb-t-1996-100-o6F5aK25iZbYaizXZOPQ7biRrfMkRCVE.jpeg"
            alt=""
          />
          <p>Jobs & Career</p>
        </div>
        <div className="sidebarOption">
          <img
            src="https://qph.fs.quoracdn.net/main-thumb-t-167403-100-uydbqrqjxxbipcmxlylpetyuwcnyzcnx.jpeg"
            alt=""
          />
        ...
        <div class="q-box qu-borderBottom"></div>
        <div className="q-box q-width">
          <span>About . </span>
          <span>Careers . </span>
          <span>Terms . </span>
          <span>Privacy . </span>
